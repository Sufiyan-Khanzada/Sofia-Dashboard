...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/ui-elements/ui-listgroup.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Nov 2022 18:18:54 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>::eBazar:: Ui Listgroup </title>
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse show" id="menu-Components">
                            ...
                            <li><a class="ms-link active" href="ui-listgroup.html"><span>List</span> group</a></li>
                                                        ...
                                                        <ul class="list-unstyled list-group list-group-custom list-group-flush mb-0">
                                                            <li class="list-group-item d-flex align-items-center py-3">
                                                                <div class="form-check form-switch">
                                                                    ...
                                                                    <label class="form-check-label ms-2" for="list-group1">Front Door</label>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item d-flex align-items-center py-3">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox" id="list-group2" checked="">
                                                                    <label class="form-check-label ms-2" for="list-group2">Air Conditioner</label>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item d-flex align-items-center py-3">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox" id="list-group3">
                                                                    <label class="form-check-label ms-2" for="list-group3">Enable RTL Mode!</label>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item d-flex align-items-center py-3">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox" id="list-group4">
                                                                    <label class="form-check-label ms-2" for="list-group4">Front Door</label>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item d-flex align-items-center py-3">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox" id="list-group5">
                                                                    <label class="form-check-label ms-2" for="list-group5">Air Conditioner</label>
                                                                </div>
                                                            </li>
                                                            <li class="list-group-item d-flex align-items-center py-3">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input" type="checkbox" id="list-group6" checked="">
                                                                    <label class="form-check-label ms-2" for="list-group6">Washing Machine</label>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    </div>
