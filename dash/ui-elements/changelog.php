...
<!-- Mirrored from pixelwibes.com/template/ebazar/html/dist/ui-elements/changelog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Nov 2022 18:18:55 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>::eBazar:: Changelog </title>
        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li><a class="m-link active" href="changelog.html"><i class="icofont-edit"></i> <span>Changelog</span> <span
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <div class="pt-2">
                                        <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.2.0</span></h6>
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–- Oct 18, 2022</span>
                                        <ul class="ms-5">
                                            <li>Add New page for Accounts 
                                                <ul>
                                                    <li>Add <a href="../create-invoice.html" class="text-primary text-decoration-underline">Create-Invoice</a> Page.(Add dynamic detail end generate pdf for invoice )</li>  
                                                </ul>
                                            </li>
                                            <li>Apexcharts ^3.33.2 to Latest Update Apexcharts": "^3.36.0"</li>
                                            <li>Datatables ^1.11.5 to Latest Update Apexcharts": "^1.12.1"</li>
                                            <li>prismjs ^1.27.0 to Latest Update Prismjs": "^1.29.0"</li>
                                            
                                        </ul>
                                    </div>
                                    <div class="pt-2">
                                        <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.2.0</span></h6>
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–- March 03, 2022</span>
                                        <ul class="ms-5">
                                            <li>Apexcharts 3.29.0 to Latest Update Apexcharts": "^3.33.1"</li>
                                            <li>Datatables 1.10.22 to Latest Update Apexcharts": "^1.11.5"</li>
                                            <li>prismjs 1.25.0 to Latest Update Prismjs": "^1.27.0"</li>
                                            <li>New Pages Add.
                                                <ul>
                                                    <li>Add New Todo-List Page .</li>  
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pt-2">
                                        <h6 class="d-inline-block"><span class="badge bg-warning font-weight-light">v1.1.0</span></h6>
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–-- Oct 25, 2021</span>
                                        <ul class="ms-5">
                                            <li>Bootstrap 5.0.2 to Latest Update Bootstrap": "^5.1.3"</li>
                                            <li>Apexcharts 3.26.0 to Latest Update Apexcharts": "^3.29.0"</li>
                                            <li>prismjs 1.23.0 to Latest Update Bootstrap": "^1.25.0"</li>
                                            <li>Layouts and pages (Add & edit).
                                                <ul>
                                                    <li>Add scroll for main page layouts.</li>
                                                    <li>Add Scroll for side menu.</li>
                                                    <li>Add New Contact Page</li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="pt-2">
                                        ...
                                        <span class="text-muted">&nbsp;&nbsp;&nbsp;–- Sep 24, 2021</span>
                                        <ul class="ms-5">
