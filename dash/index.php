                ...
                <div class="container-xxl">
                            ...
                            <div class="alert-success alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        <div class="h6 mb-0">Income Stats</div>
                        ...
                        <div class="col">
                            <div class="alert-danger alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        <div class="h6 mb-0">Revenue, Commision</div>
                        ...
                        <div class="col">
                            <div class="alert-warning alert mb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-fill ms-3 text-truncate">
                                        <div class="h6 mb-0">Customer's Income</div>
                                    ...
                                    <div class="row g-1 g-sm-3 mb-3 row-deck">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6">
                                            <div class="card">
                                                <div class="card-body py-xl-4 py-3 d-flex flex-wrap align-items-center justify-content-between">
                                                    <div class="left-info">
                                                        <span class="text-muted">Featured Profiles</span>
                    ...
                    <div class="row g-3 mb-3 row-deck">
                        ...
                        <div class="col-lg-8 col-md-12">
                            <div class="card">
                                <div class="card-header py-3 d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                                    <h6 class="m-0 fw-bold">Avg Monthly Earning</h6>
                                </div>
                                <div class="card-body">
                                    <div class="h2 mb-0">$1105.5</div>
                                    <span class="text-muted small">Avg Monthly Earning </span>
                    ...
                    <div class="row g-3 mb-3"> 
                        <div class="col-md-12">
                            <div class="card"> 
                                <div class="card-header py-3 d-flex justify-content-between align-items-center bg-transparent border-bottom-0">
                                    <h6 class="m-0 fw-bold">Uploaded Products</h6>
                                </div>
                                <div class="card-body"> 
                                    <table id="myDataTable" class="table table-hover align-middle mb-0" style="width: 100%;">  
                                        <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="badge bg-warning">Progress</span>
