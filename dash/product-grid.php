                        ...
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                ...
                                <div class="btn-group group-link btn-set-task w-sm-100">
                                    <a href="product-grid.php" class="btn active d-inline-flex align-items-center" aria-current="page"><i class="icofont-wall px-2 fs-5"></i>Grid View</a>
                                    <a href="product-list.php" class="btn d-inline-flex align-items-center"><i class="icofont-listing-box px-2 fs-5"></i> List View</a>
                                </div>
                            </div>
                        </div>
                    </div> <!-- Row end  -->
                                        ...
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-1.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                            ...
                                            <div class="product-content p-3">
                                                ...
                                                <a href="product-detail.php" class="fw-bold">Oculus VR </a>
                                                <p class="text-muted">Reference 1204</p>
                                                <span class="d-block fw-bold fs-5 text-secondary">$ 149</span>
                                                <a href="product-cart.php" class="btn btn-primary mt-3">Add to Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="card">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-2.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                                <a class="add-wishlist" href="#">
                                            ...
                                            <div class="product-content p-3">
                                                ...
                                                <a href="product-detail.php" class="fw-bold">Wall Clock </a>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-3.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                                <a class="add-wishlist" href="#">
                                                    <i class="bi bi-heart text-danger"></i>
                                                </a>
                                            ...
                                            <div class="product-content p-3">
                                                ...
                                                <a href="product-detail.php" class="fw-bold">Note Diaries </a>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-4.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                                <a class="add-wishlist" href="#">
                                                    <i class="bi bi-heart-fill text-danger"></i>
                                                </a>
                                            ...
                                            <div class="product-content p-3">
                                                ...
                                                <a href="product-detail.php" class="fw-bold">Flower Port </a>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-5.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                                <a class="add-wishlist" href="#">
                                                    <i class="bi bi-heart text-danger"></i>
                                                </a>
                                            ...
                                            <div class="product-content p-3">
                                                <span class="rating mb-2 d-block"><i class="icofont-star text-warning"></i> 4.5 (145)</span>
                                                <a href="product-detail.php" class="fw-bold">School Bag   </a>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-6.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                                <a class="add-wishlist" href="#">
                                                    <i class="bi bi-heart text-danger"></i>
                                                </a>
                                            ...
                                            <div class="product-content p-3">
                                                ...
                                                <a href="product-detail.php" class="fw-bold">Rado Watch </a>
                                ...
                                <div class="col">
                                    <div class="card">
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="product-item active">
                                                    <img src="assets/images/product/product-7.jpg" alt="product" class="img-fluid w-100">
                                                </div>
                                                <a class="add-wishlist" href="#">
                                                    <i class="bi bi-heart-fill text-danger"></i>
                                                </a>
                                            ...
                                            <div class="product-content p-3">
                                                ...
                                                <a href="product-detail.php" class="fw-bold">Traveling Bag </a>
