        ...
        <div class="sidebar px-4 py-4 py-md-4 me-0">
            <div class="d-flex flex-column h-100">
                ...
                <span class="logo-icon">
                    ...
                    <span class="logo-text">Sofia</span>
                </a>
                <!-- Menu: main ul -->
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#menu-product" href="#">
                            ...
                            <ul class="sub-menu collapse" id="menu-product">
                                ...
                                <li><a class="ms-link" href="pendingproduct.php">Product Pending</a></li>
                    ...
                    <li class="collapsed">
                        <a class="m-link" data-bs-toggle="collapse" data-bs-target="#categories" href="#">
                            ...
                            <ul class="sub-menu collapse" id="categories">
                                <li><a class="ms-link" href="categories-list.php">Categories List</a></li>
                              
                                <li><a class="ms-link" href="categories-add.php"> Add Categories</a></li>
                                <li><a class="ms-link" href="add-brands.php"> Add Brands</a></li>
                            </ul>
                    </li>
                    <li class="collapsed">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="menu-Componentsone">
                            <li><a class="ms-link" href="invoices.php">Invoices </a></li>
                             <li><a class="ms-link" href="expenses.php">All Transaction </a></li>
                        ...
                        <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                            ...
                            <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                                ...
                                <a class="nav-link dropdown-toggle pulse p-0" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static">
                                    <img class="avatar lg rounded-circle img-thumbnail" src="<?php echo $_SESSION['image']?>" alt="<?php echo $_SESSION['name']?>">
                                </a>
                                <div class="dropdown-menu rounded-lg shadow border-0 dropdown-animation dropdown-menu-end p-0 m-0">
                                    <div class="card border-0 w280">
                                        <div class="card-body pb-0">
                                            <div class="d-flex py-1">
                                                <img class="avatar rounded-circle" src="<?php echo $_SESSION['image']?>" alt="<?php echo $_SESSION['name']?>">
